...
const SubHeader = ({data}) => {
  ...
  return (
    ...
    <div className=''>
    <h1 className=' text-[3.4rem] font-thmFont font-semibold text-white border-b-2 border-thmBase rounded leading-[3rem] text-center'>{heading}</h1>
    <div className='flex items-center gap-2 justify-center text-white text-[1.2rem] font-medium font-inter mt-2'>
{
    bredcrum.map((item,i)=>{
